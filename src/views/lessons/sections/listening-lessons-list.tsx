...
function ListeningLessonCard({ lesson }: { lesson: ListeningLessonSummary }) {
  return (
    <div className="col-12">
      <div className="course-item bg-main-25 rounded-16 border-neutral-30 list-view h-100 border p-24">
        <div className="course-item__content flex-grow-1">
          <div className="flex flex-wrap items-start justify-between gap-16">
            <div>
              <p className="mb-8 text-sm font-medium text-neutral-500">{lesson.id}</p>
              <h4 className="mb-16">
                <Link
            ...
            >
              Start lesson
              <i className="ph-bold ph-arrow-right flex text-lg"></i>
            </Link>
          </div>
        </div>
      </div>
              ...
              <form action="#">
                ...
                <div className="flex-column flex gap-16">
                  <div className="flex items-center justify-between gap-16">
                    ...
                    <span className="text-neutral-500">{lessons.length}</span>
                  </div>
                </div>
                <a
                  href="course.html"
            ...
            <div className="course-list-wrapper">
              <div className="mb-40 flex flex-wrap items-center justify-between gap-16">
                <span className="text-neutral-500">
                  Showing {lessons.length} of {lessons.length} Results
                </span>
                <button
                  type="button"
